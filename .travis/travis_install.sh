...
python -m pip install pydot-ng flake8-future-import nose-exclude nose-timer
else
...
python -m pip install -q pydot-ng flake8-future-import sphinx_rtd_theme nose-exclude nose-timer
fi
