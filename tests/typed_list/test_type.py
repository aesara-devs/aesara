...
class TestTypedListType:
    ...
    def test_type_equality(self):
        ...
        # list of matrices
        myType1 = TypedListType.subtype(
            TensorType.subtype(aesara.config.floatX, (False, False))
        )
        # list of matrices
        myType2 = TypedListType.subtype(
            TensorType.subtype(aesara.config.floatX, (False, False))
        )
        # list of scalars
        myType3 = TypedListType.subtype(TensorType.subtype(aesara.config.floatX, ()))
    ...
    def test_intern_filter(self):
        ...
        myType = TypedListType.subtype(TensorType.subtype("float64", (False, False)))
    ...
    def test_basic_nested_list(self):
        ...
        myNestedType = TypedListType.subtype(
            TensorType.subtype(aesara.config.floatX, (False, False))
        )

        myType = TypedListType.subtype(myNestedType)
    ...
    def test_comparison_different_depth(self):
        ...
        myNestedType2 = TypedListType.subtype(myNestedType)

        myNestedType3 = TypedListType.subtype(myNestedType2)
    ...
    def test_nested_list_arg(self):
        ...
        myNestedType = TypedListType.subtype(
            TensorType.subtype(aesara.config.floatX, (False, False)), 3
        )
        ...
        myManualNestedType = TypedListType.subtype(
            TypedListType.subtype(TypedListType.subtype(myType))
        )
    ...
    def test_comparison_uneven_nested(self):
        ...
        myManualNestedType1 = TypedListType.subtype(
            TypedListType.subtype(TypedListType.subtype(myType))
        )

        myManualNestedType2 = TypedListType.subtype(TypedListType.subtype(myType))
    ...
    def test_variable_is_Typed_List_variable(self):
        mySymbolicVariable = TypedListType.subtype(
            TensorType.subtype(aesara.config.floatX, (False, False))
        )()
