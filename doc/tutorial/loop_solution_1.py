...
calculate_polynomial1 = aesara.function(inputs=[coefficients, x], outputs=polynomial)
...
components, updates = aesara.scan(
    fn=lambda coeff, power, prior_value, free_var: prior_value
...
calculate_polynomial = aesara.function(
    inputs=[coefficients, x], outputs=polynomial, updates=updates
)
